...
\begin{center}
    \begin{tabular}{c|c||c|c||c|c}
        \verb!AND! & \begin{circuitikz}[scale=0.5, transform shape] 
            \draw(0,0) node[and port] {};
        \end{circuitikz} & 

        \verb!OR! & \begin{circuitikz}[scale=0.5, transform shape] 
            \draw(0,0) node[or port] {};
        \end{circuitikz} &
        \verb!NOT! & \begin{circuitikz}[scale=0.5, transform shape] 
            \draw(0,0) node[not port] {};
        \end{circuitikz} \\ \hline
        \verb!NOR! & \begin{circuitikz}[scale=0.5, transform shape] 
            \draw(0,0) node[nor port] {};
        \end{circuitikz} &
        \verb!NAND! & \begin{circuitikz}[scale=0.5, transform shape] 
            \draw(0,0) node[nand port] {};
        \end{circuitikz} &
        \verb!XOR! & \begin{circuitikz}[scale=0.5, transform shape] 
...
\vspace{-5mm}
\begin{center}
\scalebox{0.75}{\begin{karnaugh-map}[4][4][1][$x_2x_1$][$x_4x_3$]
...
\end{itemize}
\subsection{RS Latch + Gated D Latch}
...
% \begin{center}
    ...
    \begin{multicols}{2}
        ...
        \scriptsize When $S=R=0$, stores the last $Q$ value.
    \end{multicols}
}
